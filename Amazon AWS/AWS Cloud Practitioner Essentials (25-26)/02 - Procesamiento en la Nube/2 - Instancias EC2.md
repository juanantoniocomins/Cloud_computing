...
| **Familia de instancias** | Grupo de instancias con características similares |
| **Uso General** | Instancias balanceadas para la mayoría de cargas |
| **Optimizada para Computación** | Instancias con CPU potente para cálculos |
| **Optimizada para Memoria** | Instancias con mucha RAM |
| **Computación Acelerada** | Instancias con GPU para IA y gráficos |
| **Optimizada para Almacenamiento** | Instancias con discos rápidos y alto IOPS |
| **vCPU** | CPU Virtual - Núcleo de procesador virtual |
